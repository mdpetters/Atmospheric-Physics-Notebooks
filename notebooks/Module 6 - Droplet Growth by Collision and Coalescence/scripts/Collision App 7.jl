    ...
    compose(context(),
      ...
      (context(), stroke("black"),arrow(), linewidth(0.25Compose.mm),
       ...
       (context(), stroke("black"), arrow(), linewidth(0.5Compose.mm),
          line([(x1,z1+R/n), (x1, z1+R/n+0.2)]), 
          line([(x2,x2+r/n), (x2, z2+r/n+0.2)])), 
...
rx = slider(5:1.0:20, value = 5.0, label = "r")
y = slider(0:1.0:50, value = 22.0, label = "y")
z = slider(5:1.0:100, value = 45.0, label = "z")
display(hbox(Rx,rx,y,z))
map(anim2,Rx,rx,y,z)
